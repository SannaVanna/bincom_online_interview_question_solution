...
# Create SQLite DB
conn = sqlite3.connect("instance/my_bincom_test.db")
c = conn.cursor()
...
c.executescript("""DROP TABLE IF EXISTS `agentname`;
...
c.executemany("INSERT INTO agentname (name_id, firstname, lastname, email, phone, pollingunit_uniqueid) VALUES (?, ?, ?, ?, ?, ?)", agentname)

# -- --------------------------------------------------------


# -- Table structure for table `announced_lga_results`--
c.executescript("""DROP TABLE IF EXISTS `announced_lga_results`;
    CREATE TABLE IF NOT EXISTS `announced_lga_results` (
      `result_id` INTEGER PRIMARY_KEY,
...
c.executemany("INSERT INTO announced_lga_results (result_id, lga_name, party_abbreviation, party_score, entered_by_user, date_entered, user_ip_address) VALUES (?, ?, ?, ?, ?, ?, ?)", announced_lga_results)

# -- --------------------------------------------------------


# -- Table structure for table `announced_pu_results`--
c.executescript("""DROP TABLE IF EXISTS announced_pu_results;
...
c.executemany(
    "INSERT INTO announced_pu_results (result_id, polling_unit_uniqueid, party_abbreviation, party_score, entered_by_user, date_entered, user_ip_address) VALUES (?, ?, ?, ?, ?, ?, ?)", announced_pu_results)

# -- --------------------------------------------------------


# -- Table structure for table `announced_ward_results`--
c.executescript(""" DROP TABLE IF EXISTS `announced_ward_results`;
...
c.executescript(""" DROP TABLE IF EXISTS `lga`;
CREATE TABLE IF NOT EXISTS `lga` (
  `uniqueid` INTEGER PRIMARY_KEY,
...
c.executemany("INSERT INTO lga (uniqueid, lga_id, lga_name, state_id, lga_description, entered_by_user, date_entered, user_ip_address) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", lga)

# -- --------------------------------------------------------


# -- Table structure for table `party`--
c.executescript(""" DROP TABLE IF EXISTS `party`;
...
c.executemany("INSERT INTO party (id, partyid, partyname) VALUES(?, ?, ?)", party)

# -- --------------------------------------------------------


# -- Table structure for table `polling_unit`--
c.executescript(""" DROP TABLE IF EXISTS polling_unit;
...
polling_unit = [
    ...
    (9, 4, 1, 19, 194, 'DT1901004', 'Primary School in Aghara', 'Primary School in Aghara', '5.599585986',
     '6.001336288', None, None, None),
    ...
    (
        55, 10, 10, 15, 156, 'DT1510010', 'cable point i', 'cable point i', '5.867691306', '5.818044285', None, None,
        None),
    ...
    (
        86, 8, 8, 6, 60, 'DT688', 'ethiope', 'ethiope west ', '5.802012582', '5.895422869', 'Israel',
        '0000-00-00 00:00:00',
        '192.168.1.104'),
    (
        87, 2, 8, 6, 60, 'DT682', 'ethiope', 'ethiope west ', '5.802052137', '5.895223879', 'Israel',
        '0000-00-00 00:00:00',
        '192.168.1.104'),
...
c.executemany(
    "INSERT INTO polling_unit (uniqueid, polling_unit_id, ward_id, lga_id, uniquewardid, polling_unit_number, polling_unit_name, polling_unit_description, lat, long, entered_by_user, date_entered, user_ip_address) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", polling_unit)

# -- --------------------------------------------------------


# -- Table structure for table `states`--
c.executescript(""" DROP TABLE IF EXISTS `states`;
    CREATE TABLE IF NOT EXISTS `states` (
      `state_id` INTEGER PRIMARY_KEY,
...
c.executemany("INSERT INTO states (`state_id`, `state_name`) VALUES (?, ?)", states)

# -- --------------------------------------------------------


# -- Table structure for table `ward`--
c.executescript(""" DROP TABLE IF EXISTS `ward`;
...
ward = [
    ...
    (
        186, 5, 'Opete / Assagba / Edjophe', 18, 'Opete / Assagba / Edjophe', 'Bincom', '0000-00-00 00:00:00',
        '127.0.0.1'),
...
c.executemany(
    "INSERT INTO `ward` (`uniqueid`, `ward_id`, `ward_name`, `lga_id`, `ward_description`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", ward)
