...
CREATE TABLE IF NOT EXISTS `announced_lga_results` (
  `result_id` int(11) NOT NULL INTEGER PRIMARY_KEY,
...
) DEFAULT CHARSET=latin1 AUTO_INCREMENT=244 ;
...
CREATE TABLE IF NOT EXISTS `announced_pu_results` (
  ...
  `user_ip_address` varchar(50) NOT NULL,
  PRIMARY KEY (`result_id`)
) DEFAULT CHARSET=latin1 AUTO_INCREMENT=261 ;
...
CREATE TABLE IF NOT EXISTS `lga` (
  `uniqueid` int(11) NOT NULL INTEGER PRIMARY_KEY,
...
) DEFAULT CHARSET=latin1 AUTO_INCREMENT=26 ;
